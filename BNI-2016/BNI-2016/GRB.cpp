...
#define TS(n) Rule::Chain::T(n)
	...
	Greibach greibach(
		...
		Rule(
			...
			5,                                // S->m{NrE;}; | m{N}; | m{NrE;};S | tfi(F){NrE;};S |  tfi(F){NrE;}; | tfi(F){N};
		...
		Rule(
			...
			Rule::Chain(5, TS('w'), TS('('), NS('E'), TS(')'),  NS('N')),					//цикл
			...
			Rule::Chain(2, TS('d'),  TS(';')),														//вывод выражения 
			Rule::Chain(6, TS('w'), TS('('), NS('E'), TS(')'),  NS('N'), NS('N')),			//цикл
			...
			Rule::Chain(3, TS('d'), TS(';'), NS('N'))												//вывод выражения 
			),
		Rule(
