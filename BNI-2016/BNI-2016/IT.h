...
#define TI_STRDEFAULT	"\0"		//значение по умолчанию дл€ типа string
...
namespace IT
{
	...
	int IsLiteral(IdTable&, char*);								//провер€ет, есть ли такой литерал в “»
	void RestartId(IT::Entry& e);								//перезагрузка элемента таилц идентификаторов;
	short   getIdxTI(char l, IT::IdTable& it);					// получить индекс “»
