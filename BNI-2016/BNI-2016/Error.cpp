...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = //таблица ошибок
	{
		...
		ERROR_ENTRY(117, "IN: Слишком длинная цепочка"),
		...
		ERROR_ENTRY(600, "CA: Неверная структура программы"),
		ERROR_ENTRY(601, "CA: Ошибочный оператор"),
		ERROR_ENTRY(602, "CA: Ошибка в выражении"),
		ERROR_ENTRY(603, "CA: Ошибка в параметрах функции"),
		ERROR_ENTRY(604, "CA: Ошибка в параметрах вызываемой функции"),
		ERROR_ENTRY(605, "CA: Ошибка знака в выражении"),
		...
		ERROR_ENTRY(705, "CмА: Ошибочный тип параметра"),
		ERROR_ENTRY(706, "CМA: Ошибка в семантическом анализе"),
		ERROR_ENTRY(707, "CмА: Наличие нескольких главных функций"),
		ERROR_ENTRY(708, "CмА: Неверное кол-во параметров в вызываемй функции"),
		ERROR_ENTRY(709, "CмА: Попытка вернуть или вывести выражение"),
